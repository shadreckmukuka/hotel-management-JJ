...
<html>
	...
	<body>
		...
		<div class="row">
  			<div class="column">
    			<img src="3.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
		...
		<div class="row">
  			<div class="column">
    			<img src="A1.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="A2.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="A3.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br>
		<div class="row">
  			<div class="column">
    			<img src="A5.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="A4.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="A5.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br><br><br>
